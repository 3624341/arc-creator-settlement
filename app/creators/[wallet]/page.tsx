...
export default function PublicCreatorProfilePage() {
  ...
  if (!profile || !verification) return <Shell><section className="rounded-[2rem] border border-arc-line bg-white/80 p-8"><h1 className="text-3xl font-black">Creator profile unavailable</h1><p className="mt-3 break-all text-sm text-arc-muted">No public Creator Passport is available for {short(wallet)}.</p></section></Shell>;
